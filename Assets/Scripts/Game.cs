...
public class Game : MonoBehaviour {
    ...
    [SerializeField] GameObject MissonPanel;
    [SerializeField] GameObject CoverField;
    [SerializeField] GameObject Purchase;
    [SerializeField] GameObject[] Commodity;
    [SerializeField] GameObject Instruction_Move_SE;
    [SerializeField] GameObject Instruction_Move_N;
    [SerializeField] GameObject Instruction_Move_H;
    [SerializeField] GameObject Instruction_Attack;
    [SerializeField] GameObject Instruction_Assign_EN;
    [SerializeField] GameObject Instruction_Assign_H;

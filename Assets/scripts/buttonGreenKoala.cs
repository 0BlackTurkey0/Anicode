...
public class buttonGreenKoala : MonoBehaviour
{
    ...
    void Start()
    {
        this.GetComponent<Button>().onClick.AddListener(clickGreenKoala);
    }
    ...
    void clickGreenKoala()
    {
        ...
        greenKoalaImage.SetActive(true);

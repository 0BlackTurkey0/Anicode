...
public class buttonGreenKangaroo : MonoBehaviour
{
    ...
    void Start()
    {
        this.GetComponent<Button>().onClick.AddListener(clickGreenKangaroo);
    }
    ...
    void clickGreenKangaroo()
    {
        ...
        greenKangarooImage.SetActive(true);

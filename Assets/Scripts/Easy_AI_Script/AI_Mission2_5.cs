...
public class AI_Mission2_5 : MonoBehaviour
{
    private Game game;
    ...
    private void Check()
    {
        ...
        if (game.Players[0].Code[(ushort)preProgramCounter] != null)
        {
            ...
            {
                //if v2 < C
                if (game.Players[0].Code[(ushort)preProgramCounter].Arguments[0] == 3 && game.Players[0].Code[(ushort)preProgramCounter].Arguments[1] == 4 && game.Players[0].Code[(ushort)preProgramCounter].Arguments[2] == 0)
                {
                    Mission1 = true;
                    if_Flag = true;

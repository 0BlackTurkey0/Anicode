...
public class buttonGreenWhale : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            this.GetComponent<Button>().onClick.AddListener(clickGreenWhale);
        }

    }
    void clickGreenWhale()
    {
        ...
        greenWhaleImage.SetActive(true);

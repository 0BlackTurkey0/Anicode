...
public class buttonBlueKangaroo : MonoBehaviour
{
    ...
    void Start()
    {
        this.GetComponent<Button>().onClick.AddListener(clickBlueKangaroo);
    }
    ...
    void clickBlueKangaroo()
    {
        ...
        blueKangarooImage.SetActive(true);
